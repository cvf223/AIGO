        ...
        <div>
          ...
          <div className="space-y-2">
            ...
            <label className="flex items-center space-x-3 cursor-pointer p-2 hover:bg-steel-600 rounded transition-colors">
              <input
                type="checkbox"
                checked={config.enableZAP}
                onChange={() => toggleMethod('enableZAP')}
                className="w-5 h-5 accent-compliance-green"
              />
              <div className="flex-1">
                <div className="flex items-center justify-between">
                  <div className="font-body text-sm">Zero-shot Action Planning (ZAP)</div>
                  {config.enableZAP && (
                    <span className="ml-2 text-xs font-mono text-construction-orange animate-pulse-slow">⚡ ACTIVE</span>
                  )}
                </div>
                <div className="text-xs font-mono text-steel-400">Construction action planning</div>
              </div>
            </label>
          </div>
        </div>
