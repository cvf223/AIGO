...
The system includes a comprehensive test script (`test-background-tasks.js`) that:

- Simulates swap events with various price impacts
...
1. Run `npm run test-tasks` to execute the test script
2. The test will run for 30 seconds by default
3. It will simulate swap events, task execution, and opportunity discovery
4. Status reports will be displayed every 5 seconds
5. After completion, a final status report will be displayed 