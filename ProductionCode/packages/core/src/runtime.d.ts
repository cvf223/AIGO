import { type Character, type HandlerCallback, type IAgentRuntime, type ICacheManager, type IDatabaseAdapter, type IMemoryManager, type IRAGKnowledgeManager, ModelProviderName, type Plugin, type Provider, type Adapter, type Service, type ServiceType, type State, type UUID, type Action, type Evaluator, type Memory, type ClientInstance } from "./types";
export interface ClientInstanceWithBot extends ClientInstance {
    bot?: any;
}
export interface IAgentRuntimeWithAnnouncement extends IAgentRuntime {
    sendGroupAnnouncement: (fact: {
        claim: string;
        proof: string;
...
export declare class AgentRuntime implements IAgentRuntimeWithAnnouncement {
    #private;
    /**
     * The ID of the agent
     */
