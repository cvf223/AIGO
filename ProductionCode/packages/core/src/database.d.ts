...
export declare abstract class DatabaseAdapter<DB = any> implements IDatabaseAdapter {
    ...
    /**
     * Creates a new room with an optional UUID.
     * If no UUID is provided, a new one will be generated.
     * @param roomId - Optional UUID for the room. If not provided, a new UUID will be generated.
     * @returns A Promise that resolves to the UUID of the created room.
     */
    abstract createRoom(roomId?: UUID | string | null): Promise<UUID>;
    /**
