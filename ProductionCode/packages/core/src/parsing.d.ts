 ...
 */
export declare const parseBooleanFromText: (text: string) => boolean | null;
 ...
 */
export declare function parseJsonArrayFromText(text: string): any[] | null;
/**
 ...
 */
export declare function parseJSONObjectFromText(text: string): any;
/**
