...
import { comprehensivePersistence } from './ComprehensivePersistenceLayer.js';
...
export class IntegrateAdvancedMemory {
    constructor() {
        ...
        this.persistenceLayer = comprehensivePersistence;
    ...
    async integrateWithAgents(syndicateFactory) {
        ...
        if (!syndicateFactory.agents || !(syndicateFactory.agents instanceof Map)) {
            console.warn('⚠️ No agents Map found in syndicateFactory - skipping agent integration');
            return;
        }
    ...
    async connectRewardSystem(syndicateFactory) {
        ...
        if (!syndicateFactory.rewardPenaltyEngine && !syndicateFactory.decisionAwareness) {
            console.warn('⚠️ No reward systems found in syndicateFactory - skipping reward integration');
            return;
        }
    ...
    async integrateCollectiveLearning(syndicateFactory) {
        ...
        if (!hasCollectiveLearning) {
            console.warn('⚠️ No collective learning systems found - skipping integration');
            return;
        }
