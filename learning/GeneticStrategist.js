...
export class GeneticStrategist {
    ...
    async deviseMutationStrategy(elites) {
        ...
        const context = this.contextEngine ? await this.contextEngine.buildContext({
            ...
            task: 'genetic_mutation_strategy',
            contextualStrategy: 'balanced',
            riskLevel: 'moderate',
            opportunityScore: 0.5,
            environmentalFactors: ['adaptive', 'evolutionary', 'resilient'],
            suggestedApproach: 'Use balanced mutation with focus on fitness improvement'
        };
