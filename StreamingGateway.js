    ...
    async createStreamingTables() {
        const queries = [
            `CREATE TABLE IF NOT EXISTS stream_thought_history (
                ...
                INDEX idx_stream_thought_agent (agent_id),
                INDEX idx_stream_thought_time (timestamp DESC)
            )`,
            ...
            `CREATE TABLE IF NOT EXISTS stream_decision_history (
                ...
                metadata JSONB,
                timestamp TIMESTAMPTZ DEFAULT NOW(),
                INDEX idx_stream_decision_agent (agent_id),
                INDEX idx_stream_decision_time (timestamp DESC)
            )`,
            ...
            `CREATE TABLE IF NOT EXISTS stream_quantum_states (
                ...
                visualization JSONB,
                timestamp TIMESTAMPTZ DEFAULT NOW(),
                INDEX idx_stream_quantum_system (system_id),
                INDEX idx_stream_quantum_time (timestamp DESC)
            )`,
            ...
            `CREATE TABLE IF NOT EXISTS stream_tool_executions (
                ...
                duration FLOAT,
                timestamp TIMESTAMPTZ DEFAULT NOW(),
                INDEX idx_stream_tool_agent (agent_id),
                INDEX idx_stream_tool_name (tool)
            )`
        ];
