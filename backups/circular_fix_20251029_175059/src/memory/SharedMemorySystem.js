...
export class SharedMemorySystem extends EventEmitter {
    constructor(databaseConfig) {
        super();
        this.memory = new Map();
        this.database = new Pool(typeof databaseConfig === 'object' && databaseConfig.connect ? databaseConfig : (typeof databaseConfig === 'string' ? JSON.parse(databaseConfig) : databaseConfig));
